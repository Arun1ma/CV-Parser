...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='akshaya',db='cv')
...
def run():
    ...
    link = '<b>Built with 🤍 by Akshaya and Arunima</b>' 
    ...
    if choice == 'User':
        ...
        if pdf_file is not None:
            ...
            save_image_path = 'C:/Users/Akshaya/AI-Resume-Analyzer/App/Uploaded_Resumes/'+pdf_file.name
